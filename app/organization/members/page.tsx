    ...
    <OrganizationPortalLayout organizationName={organization?.name}>
      <div className="space-y-8 pb-20">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="relative size-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden">
        ...
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between">
          ...
          <Link
            href="/organization/invitations"
            className="text-[10px] font-black text-accent-cyan uppercase tracking-widest hover:underline"
          >
            Manage Access
          </Link>
        </div>
